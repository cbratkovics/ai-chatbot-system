...
class ScalableWebSocketManager:
    ...
    def _setup_event_handlers(self):
        ...
        async def connect(sid, environ, auth):
            ...
            try:
                ...
                logger.info(f"User {connection.user_id} connected with session {connection.session_id}")
    ...
    async def _handle_chat_message(self, connection: WebSocketConnection, data: Dict[str, Any]):
        ...
        try:
            ...
            # Send ACK to sender
            await self.sio.emit('message_ack', {
    ...
    async def _handle_typing_message(self, connection: WebSocketConnection, data: Dict[str, Any]):
        ...
        try:
            ...
            await self.sio.emit('typing', typing_data, 
                              room=connection.room, 
                              skip_sid=connection.socket_id)
    ...
    async def _update_user_presence(self, user_id: str, status: str, device_info: Dict[str, Any] = None):
        ...
        try:
            ...
            await self.redis.lpush(
                ...
                json.dumps({
                    ...
                    'expires_at': queued_message.expires_at.isoformat() if queued_message.expires_at else None
                })
            )
        ...
        try:
            ...
            for message_data in messages:
                try:
                    ...
                    await self.sio.emit('queued_message', message['content'], 
                                      room=connection.socket_id)
    ...
    async def _store_disconnection_info(self, connection: WebSocketConnection):
        ...
        try:
            ...
            await self.redis.setex(
                f"disconnect:{connection.session_id}",
                3600,
                json.dumps(disconnect_info)
            )
    ...
    async def _handle_presence_message(self, connection: WebSocketConnection, data: Dict[str, Any]):
        ...
        try:
            ...
            await self._update_user_presence(
                connection.user_id, 
                status, 
                connection.metadata.get('device_info', {})
            )
