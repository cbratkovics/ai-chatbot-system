...
class TestDatabaseOperations:
    ...
    async def test_database_backup_restore(self, mock_database):
        ...
        from app.utils.database_backup import backup_database, restore_database
    ...
    async def test_database_partitioning(self, mock_database):
        ...
        from app.models import ChatPartitioned
    ...
    async def test_database_read_replica(self):
        ...
        from app.database import get_read_replica_session
