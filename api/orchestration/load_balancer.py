...
class LoadBalancer:
    ...
    async def _update_health_score(self, instance: ProviderInstance):
        ...
        if instance.health_score < 0.2:
            ...
            logger.warning(f"Instance {instance.id} marked unavailable (health: {instance.health_score:.2f})")
            ...
            try:
                ...
                for instance in self.instances.values():
                    task = asyncio.create_task(
                        self._check_instance_health(instance, check_func)
                    )
                    tasks.append(task)
    ...
    def get_instance_stats(self, instance_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "last_error": instance.last_error_time.isoformat() if instance.last_error_time else None
        }
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "instances": [
                self.get_instance_stats(inst_id)
