...
class CapabilityBasedStrategy(RoutingStrategy):
    ...
    async def select_model(
        ...
        if not capable_models:
            raise ValueError(f"No models with required capabilities: {context.required_capabilities}")
